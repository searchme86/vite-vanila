import P from"https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.mjs";const l=t=>document.querySelector(t);l(".box__cartItem-container");const q=l(".text__count"),v=l(".box__cartItem-container"),x=l(".text__total-price"),d=l(".box__modal-layer"),f=l(".button__close-layer"),M=l(".button__item-cart"),D=l(".list__card-products"),N=document.querySelector(".swiper-wrapper"),H=l(".list__companies");l(".featured-center");const z=l(".box__search-item");l(".box__price-filter .box__input-box input");const F=l(".search-input"),m=t=>{let s=localStorage.getItem(t)==="undefined"?[]:localStorage.getItem(t);const n=JSON.parse(s)||[];if(n!==void 0)return n},g=(t,s)=>{s!==void 0&&localStorage.setItem(t,JSON.stringify(s))};let V=m("store");const j=t=>{const{id:s,title:n,price:a,category:e,thumbnail:i,description:c,discountPercentage:r,rating:_,stock:p,brand:A}=t;return{id:s,title:n,price:a,category:e,thumbnail:i,description:c,discountPercentage:r,rating:_,stock:p,brand:A}},G=t=>{g("store",t.map(j))},h=({id:t,title:s,price:n,thumbnail:a,amount:e})=>{const i=document.createElement("li");return i.classList.add("swiper-slide"),i.setAttribute("data-id",t),i.innerHTML=`
  ...
  `,i},K=({id:t,title:s,thumbnail:n,price:a,description:e,discountPercentage:i,rating:c,stock:r,brand:_})=>`
  ...
  `,Q=({id:t,brand:s,description:n,title:a,price:e,discountPercentage:i,rating:c,stock:r,amount:_})=>`
  ...
  `,Y=({brand:t,category:s,title:n,description:a,price:e,discountPercentage:i,stock:c,rating:r})=>`
  ...
  `;let b,o=(b&&b.destroy(),b=new P(".swiper",{on:{slideChange:t=>{(s=>{const{slides:n,realIndex:a}=s;n.forEach((e,i)=>{((c,r)=>{const _=r?"false":"true",p=r?"0":"-1";c.setAttribute("aria-hidden",_),c.setAttribute("tabindex",p)})(e,i===a)})})(t)}},a11y:{enabled:!0,containerMessage:"카트 등록상품 미리보기 슬라이더",containerRoleDescriptionMessage:"carousel",slideRole:"group",prevSlideMessage:"이전 슬라이드",nextSlideMessage:"다음 슬라이드",slideLabelMessage:"현재 {{index}}번째 슬라이드 / 총 {{slidesLength}}개의 슬라이드",firstSlideMessage:"첫번째 슬라이드 입니다",lastSlideMessage:"마지막 슬라이드 입니다."},allowTouchMove:!0,keyboard:{enabled:!0},pagination:{el:".swiper-pagination"},slidesPerView:3,spaceBetween:15,breakpoints:{360:{slidesPerView:1,spaceBetween:10},760:{slidesPerView:3,spaceBetween:10},861:{slidesPerView:3,spaceBetween:10},1024:{slidesPerView:3,spaceBetween:15}}}),b);const $=()=>m("cart"),w=()=>{const t=$().reduce((s,n)=>s+n.amount,0);q.textContent=t},I=()=>{const t=$().reduce((s,n)=>s+n.price*n.amount,0);x&&(x.textContent=`Total : $${t} `)},L=document.querySelector(".box__modal-layer"),S=()=>{L&&(d.classList.add("show"),d.removeAttribute("aria-modal","false"),d.removeAttribute("tabindex"),d.setAttribute("aria-modal","true"),d.setAttribute("tabindex","0")),o.init(document.querySelector(".swiper"))},B=()=>{L&&(d.classList.remove("show"),d.removeAttribute("aria-modal","true"),d.removeAttribute("tabindex"),d.setAttribute("aria-modal","false"),d.setAttribute("tabindex","-1"))};f&&(M.addEventListener("click",S),f.addEventListener("click",B));const T=S;let u;const J=document.querySelector(".swiper-wrapper"),k=()=>{g("cart",u),w(),I()},C=(t,s)=>{let n;return u=m("cart").map(e=>(e.id===Number(t)&&(n=s(e.amount),e={...e,amount:n}),e)),o&&(o.update(),o.updateSlides()),n},E=t=>C(t,s=>s+1),y=t=>{u=m("cart").filter(n=>n.id!==Number(t))},O=()=>{v&&v.addEventListener("click",t=>{const s=t.target,n=s.parentElement,a=s.dataset.id||n.dataset.id,e=n.nextElementSibling,i=n.parentElement.parentElement.parentElement;if(s.classList.contains("button__remove-item"))y(a),n.parentElement.remove(),o&&(o.updateSlides(),o.update());else if(n.classList.contains("button__increase-cartItem"))e.textContent=E(a);else if(n.classList.contains("button__decrease-cartItem")){let c=(r=>{let _=C(Number(r),p=>p-1);return _===0&&y(Number(r)),_})(a);c===0?(i.remove(),o&&(o.updateSlides(),o.update())):n.previousElementSibling.textContent=c}k(),document.querySelector(".swiper-wrapper").children.length===0&&document.querySelector(".box__modal-layer").classList.remove("show")})},Z=t=>{let s=m("cart");if(s.find(n=>n.id===Number(t))){let n=E(Number(t));v.querySelector(`[data-id="${t}"].text__cartItem-count`).textContent=n}else{let n=(e=>{const i=Number(e);return V.find(c=>c.id===i)})(t);n={...n,amount:1},u=[...s,n],g("cart",u);const a=h(n);J.appendChild(a),o&&(o.updateSlides(),o.update())}k(),o.init(),T()};w(),I(),m("cart").forEach(t=>{const s=h(t);N&&(o.appendSlide(s),o.updateSlides(),o.update())}),O();const tt=async()=>{try{const t=await fetch("https://dummyjson.com/products"),{products:s}=await t.json();return s}catch{return null}},st=async t=>{const s=`https://dummyjson.com/products/${t}`;try{return await(await fetch(s)).json()}catch{return null}};export{U as a,W as b,Q as c,X as d,Y as e,st as f,Z as g,K as h,z as i,H as j,tt as k,G as l,F as n,D as p,V as s};
//# sourceMappingURL=fetchProducts-WvVG9cTF.js.map
